...
export class CreateCvComponent implements OnInit {
  ...
  saveCv(): void {
    ...
    const request = {
      ...
      experiences: this.cvData.experiences,
    };
    ...
    this.createCvService.createCv(request).subscribe(
      (response) => {
        ...
        const newCv: StudentCv = {
          studentCvId: response.cvId,
          studentCvContent: JSON.stringify(this.cvData),
          filePath: '', // Use backend response if available
          studentCvType: this.selectedTemplate.name,
          uploadDate: response.createdDate,
          studentId: this.studentId,
        };
        this.cvs.push(newCv);
